...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <select name="type" class="form-control" required>
                ...
                <option value="1" {{ old('type') == "1" ? 'selected' : '' }}>Current Proficiency (CP) – Current Proficiency Required (CPR)</option>
                <option value="2" {{ old('type') == "2" ? 'selected' : '' }}>Current Proficiency (CP) – Future Proficiency Required (FPR)</option>
                <option value="3" {{ old('type') == "3" ? 'selected' : '' }}>Current Frequency (CF) – Current Frequency Required (CFR)</option>
                <option value="4" {{ old('type') == "4" ? 'selected' : '' }}>Current Frequency (CF) – Future Frequency Required (FFR)</option>
            </select>
        </div>
    ...
    <div class="form-group text-right">
        ...
        <input class="btn btn-primary" type="submit" value="Simpan" id="simpan">
    </div>
</form>
@stop
...
<script>
    $(document).ready(function () {
        $("#company_id").change(function () {
            ...
            $.get("{{url('data/assessment-project-participant-data')}}" + "/" + $("#company_id").val(),
