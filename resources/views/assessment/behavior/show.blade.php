            ...
            <div class="card-body">
                <form action="/assessment/behaviors" method="POST"  id="prilaku">
                  ...
                  <div class="form-group" style="margin-top: 1%">
                    ...
                    <div class="row">
                      <div class="col-sm-11">
                        <input type="text" class="form-control description @error('description') is-invalid @enderror" name="description[]" id="description" placeholder="Masukan Perlaku Kunci">
                        @error('description')
                            <div class="alert alert-danger" style="margin-top: 10px">{{$message}}</div>
                        @enderror
                        <div class="alert alert-danger d-none" style="margin-top: 10px">Perilaku Kunci tidak boleh kosong</div>
                      </div>
                      <div class="col-sm-1">
                        <button  type="button" class="btn btn-success btn-md btnStatic" id="tmb-prilaku"><i class="fas fa-plus"></i></button>
                      </div>
                    </div>
                  </div>
                </form>
                ...
                <div class="action" style="text-align: right">
                  ...
                  <button id="submit" type="text" class="btn btn-primary">Simpan</button>
                </div>
            </div>
        </div>
    </div>
