...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="action" style="text-align: right">
                        <a href="/assessment/competencies/create" class="btn btn-info">Tambah Kompetensi</a>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="action">
                            <button type="button" id="add-behavior" class="btn btn-info" style="margin-bottom: 15px">Tambah
                                Perilaku Kunci</button>
                        </div>
    ...
    {{-- modal warning --}}
    <div class="modal fade" id="warning-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
