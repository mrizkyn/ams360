          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input type="type" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Masukan Nama Asesi" value="{{old('name')}}">
                @error('name')
                <div class="alert alert-danger" style="margin-top: 10px">Nama Asesi tidak boleh kosong</div>
                @enderror
              </div>
              <div class="form-group">
                <label for="name">NIK</label>
                <input type="type" name="identity" class="form-control @error('identity') is-invalid @enderror" id="identity" placeholder="Masukan NIK" value="{{old('identity')}}">
                @error('identity')
              ...
              <div class="form-group">
                ...
                <input type="date" class="form-control @error('project_date') is-invalid @enderror" name="project_date" value="{{old('project_date')}}">
                @error('project_date')
                <div class="alert alert-danger" style="margin-top: 10px">Tanggal Proyek tidak boleh kosong</div>
                @enderror
              </div>
              <div class="form-group">
                <label for="name">Tanggal Lahir</label>
                <input type="date" name="birth" class="form-control @error('birth') is-invalid @enderror" id="birth" value="{{old('birth')}}">
                @error('birth')
                <div class="alert alert-danger" style="margin-top: 10px">Tanggal Lahir tidak boleh kosong</div>
                @enderror
              </div>
              <div class="form-group">
                <label for="name">No. Telp</label>
                <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" id="phone" placeholder="Masukan No. Telp" value="{{old('phone')}}">
                @error('phone')
                <div class="alert alert-danger" style="margin-top: 10px">No. Telp tidak boleh kosong</div>
                @enderror
              </div>
              <div class="form-group">
            ...
            <div class="col-sm-6">
              <div class="row">
                <div class="col-sm-4">
                  <div class="card" style="width: 150px;height: 150px;background: gray">
                    <img src="#" alt="your image" id="image-participant" style="width: 150px;height: 150px ; object-fit: cover; border: 1px solid #ddd; border-radius: 4px; text-align: center;color: white">
                  </div>
                </div>
                <div class="col-sm-8">
                  <div class="form-group">
                    <label for="name">Photo Asesi</label>
                    <input type="file" name="image" accept="image/*" onchange="loadFile(event)" class="form-control @error('image') is-invalid @enderror" id="image" value="{{old('image')}}">
                    @error('image')
                    <div class="alert alert-danger" style="margin-top: 10px">Photo Asesi tidak boleh kosong</div>
                    @enderror
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                @error('departement')
                <div class="alert alert-danger" style="margin-top: 10px">Harus Memilih Departemen</div>
                @enderror
              </div>
              <div class="form-group">
