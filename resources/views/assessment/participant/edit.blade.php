                  ...
                  <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="type" name="name" class="form-control @error('name') is-invalid @enderror" id="name" value="{{ $name }}">
                          @error('name')
                              <div class="alert alert-danger" style="margin-top: 10px">Nama Kompetensi tidak boleh kosong</div>
                          @enderror
                        </div>
                        <div class="form-group">
                          <label for="name">NIK</label>
                          <input type="type" name="identity" class="form-control @error('identity') is-invalid @enderror" id="identity" value=" {{ $nik }}">
                          @error('identity')
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="project_date" value="{{$projectDate}}">
                        ...
                        <div class="form-group">
                          ...
                          <input type="date" name="birth" class="form-control @error('birth') is-invalid @enderror" id="birth" value="{{ $birth }}">
                          @error('birth')
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" id="phone" value="{{ $phone }}">
                          @error('phone')
                        ...
                        <div class="form-group">
                          ...
                          <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" value="{{ $email }}">
                          @error('email')
                      ...
                      <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <img src="{{ url('/uploads/participants/'.$picture) }}" alt="your image" id="image-participant" style="width: 150px;height: 150px ; object-fit: cover; border: 1px solid #ddd; border-radius: 4px; text-align: center;color: white">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label for="name">Photo Asesi</label>
                                    <input type="file" name="image" accept="image/*" onchange="loadFile(event)" class="form-control image @error('image') is-invalid @enderror" id="image" value="{{ $picture }}" >
                                    @error('image')
