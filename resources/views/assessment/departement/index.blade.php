...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="/assessment/departements/create" class="btn btn-success" style="margin-bottom: 20px">Tambah Departemen</a>
        ...
        $(function() {
          ...
          // load datatabel
            var oTable = $('#departement-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ url("data/assessment-departement-data") }}'
                },
                columns: [
            ...
            $('#departement-table').DataTable().on('click' , 'button.delete' , function(){
              var id = $(this).attr('id');
              $('#myForm').attr('action' , '/assessment/departements/'+id);
