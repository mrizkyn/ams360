...
<form id="report-assessment-form" action="report-assessment" method="POST">
    <div class="tab">
        ...
        <div class="form-group">
            ...
            <select name="project_participant_id" id="participant_id" class="form-control" value="{{old('participant_id')}}">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#company_id').change(function(){
                $.get("{{url('data/assessment-project-data-by-company/')}}"+ "/" + $("#company_id").val(), function(data){
                    $('#project_id').empty();
                    $('#project_id').append(`<option value="" selected disabled>Pilih Nama Proyek</option>`);
            ...
            $('#project_id').change(function() {
                $.get("{{url('data/assessment-participant-data-by-project/')}}"+ "/" + $("#project_id").val(), function(data){
                    $('#participant_id').empty();
                    $('#participant_id').append(`<option value="" selected disabled>Pilih Nama Asesi</option>`);
                    data.forEach(participant => {
                        $('#participant_id').append(`<option value="${participant.id}">${participant.name}</option>`);
                    });
                });
            });
        });
