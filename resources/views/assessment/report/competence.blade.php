                    ...
                    <form id="report">
                        ...
                        <div class="form-group">
                            ...
                            <select name="competence" id="competence"
                                ...
                                <option value="company" {{ old('competence') == 'company' ? 'selected' : '' }}>Perperusahaan
                                </option>
                                <option value="all" {{ old('competence') == 'all' ? 'selected' : '' }}>Semua Kompetensi
                                </option>
                            </select>
                            @error('competence')
                        ...
                        <div style="text-align: right">
                            <button id="doc" type="button" class="btn btn-info"><i class="fas fa-file-word"></i>
                                Cetak
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="" method="POST" id="myForm">
                        ...
                        <button type="submit" type="button" class="btn btn-info">Ya</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        $(function() {
            ...
            $('button#doc').click(function() {
                if ($('select#competence option:selected').val() == "all") {
                    ...
                    if ($('select#company option:selected').val() == "0" || $(
                            'select#company option:selected').val() == "" || $(
                            'select#company option:selected').disabled == true || $(
                            'select#division option:selected').val() == "" || $(
                            'select#division option:selected').val() == "0" || $(
                            'select#division option:selected').disabled == true || $(
                            'select#departement option:selected').val() == "" || $(
                            'select#departement option:selected').val() == "0" || $(
                            'select#departement option:selected').disabled == true || $(
                            'select#position option:selected').val() == "" || $(
                            'select#position option:selected').val() == "0" || $(
                            'select#position option:selected').disabled == true) {
