...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="/db-assessment/divisions/create" class="btn btn-success">Tambah Divisi</a> <br><br>
    ...
    <script type="text/javascript">
        $(function() {
            var oTable = $('#divisions-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ url("data/dbassessment-division-data") }}'
                },
                columns: [
            ...
            $('#divisions-table').DataTable().on('click' , 'button.delete' , function(){
              var id = $(this).attr('id');
              $('#myForm').attr('action' , '/db-assessment/divisions/'+id);
