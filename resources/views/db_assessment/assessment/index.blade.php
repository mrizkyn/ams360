            ...
            <form action="/db-assessment/assessments" method="POST" id="regForm">
                ...
                <div class="tab">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-name @error('name') is-invalid @enderror"
                            id="name" placeholder="Nama Project" name="name" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control input-name @error('job') is-invalid @enderror" id="job"
                            name="job">
                ...
                <div class="tab">
                    ...
                    <div class="form-group">
                        <label for="company">Nama Perusahaan</label>
                        <input type="text" class="form-control" id="name_company" readonly name="name_company"
                            value="">
                    </div>
                    <div class="table-responsive">
                                ...
                                <tr class="trStaticStep2">
                                    <th>
                                        <div class="form-check">
                                            <input class="form-check-input test" type="checkbox" value=""
                                                id="checkAll-step2">
                                            </label>
