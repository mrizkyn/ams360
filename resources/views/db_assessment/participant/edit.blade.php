                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                placeholder="Nama Kompetensi" name="name" value="{{ $participant->name }}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('city') is-invalid @enderror" id="city"
                                placeholder="Tempat Lahir" name="city" value="{{ $participant->city }}">
                            @error('city')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('birth') is-invalid @enderror" id="birth"
                                name="birth" value="{{ $participant->birth }}">
                            @error('birth')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('phone') is-invalid @enderror" id="phone"
                                placeholder="No Telephone/Hp" name="phone" value="{{ $participant->phone }}">
                            @error('phone')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                placeholder="Alamat Email" name="email" value="{{ $participant->email }}">
                            @error('email')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('company_id') is-invalid @enderror" name="company_id"
                                ...
                                @foreach ($companies as $company)
                                    <option value="{{ $company->id }}" @if ($company->id == $participant->company_id) selected @endif>
                                        {{ $company->name }}</option>
                                @endforeach
                            </select>
                            @error('company_id')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('division') is-invalid @enderror" name="division"
                                ...
                                @foreach ($divisions as $division)
                                    <option value="{{ $division->id }}" @if ($division->id == $participant->division_id) selected @endif>
                            ...
                            <select class="form-control @error('departement') is-invalid @enderror" name="departement"
                                ...
                                @foreach ($departements as $departement)
                                    <option value="{{ $departement->id }}"
                                        @if ($departement->id == $participant->departement_id) selected @endif> {{ $departement->name }}
                                    </option>
                                @endforeach
                            </select>
                            @error('departement')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('position') is-invalid @enderror" name="position"
                                ...
                                @foreach ($positions as $position)
                                    <option value="{{ $position->id }}" @if ($position->id == $participant->position_id) selected @endif>
