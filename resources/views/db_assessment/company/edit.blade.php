                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                placeholder="Nama Perusahaan" name="name" value="{{ old('name', $company->name) }}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('business_field') is-invalid @enderror" name="business_field"
                                ...
                                @foreach ($businessFields as $businessField)
                                    <option value="{{ $businessField->name }}"
                                        @if ($company->business_field == $businessField->name) selected @endif>{{ $businessField->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('city') is-invalid @enderror" id="city"
                                placeholder="Nama Kota" name="city" value="{{ old('city', $company->city) }}">
                            @error('city')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('phone') is-invalid @enderror" id="phone"
                                placeholder="No Telephone" name="phone" value="{{ old('phone', $company->phone) }}">
                            @error('phone')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('pic_name') is-invalid @enderror"
                                id="pic_name" placeholder="Nama PIC" name="pic_name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('pic_phone') is-invalid @enderror"
                                id="pic_phone" placeholder="No Telp/Hp PIC" name="pic_phone"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('pic_mail') is-invalid @enderror"
                                id="pic_mail" placeholder="Email PIC" name="pic_mail"
                                value="{{ old('pic_mail', $company->pic_mail) }}">
                            @error('pic_mail')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
